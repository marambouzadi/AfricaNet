                        ...
                        {user ? (
                            <>
                                {user.role === 'ADMIN' && (
                                    <Link
                                        href="/admin"
                                        className="hidden items-center gap-1.5 rounded-full bg-[#1A3FA0] px-3 py-1 text-xs font-bold text-white transition-all hover:bg-[#0D2660] sm:flex"
                                    >
                                        Admin
                                    </Link>
                                )}
                                ...
                                <Link href="/dashboard" className="text-[#1A1A1A] sm:hidden" aria-label="Mon compte">
                                    <User className="h-5 w-5" />
                                </Link>
                            </>
                        ) : (
            ...
            >
                ...
                >
                    <nav className="px-6 py-5" aria-label="Navigation mobile">
                        ...
                        <div className="mt-4 border-t border-[#E2E2DF] pt-4 space-y-2">
                            {user ? (
                                <>
                                    {user.role === 'ADMIN' && (
                                        <Link
                                            href="/admin"
                                            className="flex items-center gap-2 rounded-lg bg-[#1A3FA0] px-3 py-2.5 text-base font-bold text-white transition-colors"
                                            onClick={() => setMenuOpen(false)}
                                        >
                                            <User className="h-5 w-5" />
