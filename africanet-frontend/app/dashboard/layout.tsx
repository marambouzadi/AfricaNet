...
function SidebarContent({ pathname, onClose, user }: { pathname: string, onClose?: () => void, user: UserProfile | null }) {
                    ...
                    {mobileMenuOpen && (
                        <div className="fixed inset-0 z-50 md:hidden">
                            ...
                            <div className="absolute left-0 top-0 bottom-0 w-80 bg-[#F5F5F3] p-4 overflow-y-auto shadow-2xl animate-in slide-in-from-left duration-300">
                                ...
                                <SidebarContent pathname={pathname} onClose={() => setMobileMenuOpen(false)} user={user} />
                            </div>
                        </div>
                    )}
